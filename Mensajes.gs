...
function MensajesEN ()
{
    ...
    this.getMensajeEmailCheckout= function(formulario)
    {
    return 'Hello.\n\nAs a student of the <r>'+this._programa.getNombre()+' Program</r> you must answer the following <a href="'+formulario.getPublishedUrl()+'">knowledge test</a>.\n'+
          this._getColetilla(); 
    }
    this.getMensajeEmailCheckoutTXT= function(formulario){return this._eliminarFormato(this.getMensajeEmailCheckout(formulario.getPublishedUrl()));}
